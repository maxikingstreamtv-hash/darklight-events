    ...
    <section className="relative overflow-hidden bg-black px-6 py-28 text-white">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-zinc-400">
              Bedømmelsessystem til carshows med manuelle scorefelter, strafpoint og staff-godkendelse.
            </p>
          </div>
        ...
        <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.04] p-10 text-center backdrop-blur-xl">
          ...
          <h2 className="mt-4 text-3xl font-black">Ingen car show placeringer endnu</h2>
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-zinc-500">
            Car show vindere og podier oprettes først, når staff manuelt indtaster scores,
            godkender resultaterne og offentliggør vindere.
          </p>
        </div>
      </div>
    </section>
