    ...
    <section className="relative overflow-hidden bg-black px-6 py-28 text-white">
      ...
      <div className="relative mx-auto max-w-[1600px]">
        <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-zinc-400">
              Bracket til drift-events. Vindere, point og deltagere styres via EventOS,
              når staff indtaster og godkender resultater.
            </p>
          </div>
        ...
        <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.04] p-10 text-center backdrop-blur-xl">
          ...
          <h2 className="mt-4 text-3xl font-black">Ingen drift bracket vindere endnu</h2>
          <p className="mx-auto mt-4 max-w-2xl leading-7 text-zinc-500">
            Drift og show-events sorterer højeste godkendte score bedst. Bracket vindere vises
            først efter manuel indtastning og staff-godkendelse.
          </p>
        </div>
      </div>
    </section>
